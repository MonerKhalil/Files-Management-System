...
class FileManagerRepository extends BaseRepository implements IFileManagerRepository
{
    ...
    {
        return parent::create((new FileManagerDTO($data))->toArray(), $showMessage); // TODO: Change the autogenerated stub
    }

    public function update($data, $itemId, bool $showMessage = true, ?callable $callback = null): mixed
    {
        return parent::update((new FileManagerDTO($data))->toArray(), $itemId, $showMessage, $callback); // TODO: Change the autogenerated stub
    }
}
