...
class GroupManagerRepository extends BaseRepository implements IGroupManagerRepository
{
    ...
    public function create($data, bool $showMessage = true,array $fieldsFile = []): mixed
    {
        ...
        return parent::create((new GroupManagerDTO($data))->toArray(), $showMessage,$fieldsFile); // TODO: Change the autogenerated stub
    }
    ...
    public function update($data, $itemId, bool $showMessage = true, ?callable $callback = null,array $fieldsFile = []): mixed
    {
        ...
        return parent::update((new GroupManagerDTO($data))->toArray(), $itemId, $showMessage, $callback,$fieldsFile);
    }
}
