...
class UserRepository extends BaseRepository implements IUserRepository
{
    ...
    {
        return parent::create((new UserDTO($data))->toArray(), $showMessage, $fieldsFile); // TODO: Change the autogenerated stub
    }

    public function update($data, $itemId, bool $showMessage = true, ?callable $callback = null,array $fieldsFile = []): mixed
    {
        return parent::update((new UserDTO($data))->toArray(), $itemId, $showMessage, $callback, $fieldsFile); // TODO: Change the autogenerated stub
    }
}
